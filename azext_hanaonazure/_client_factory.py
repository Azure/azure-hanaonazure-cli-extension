...
def _hana_instance_client_factory(cli_ctx, *_):
    from azext_hanaonazure.modules_sdk.v2020_02_07_preview import HanaManagementClient
    from azure.cli.core.commands.client_factory import get_mgmt_service_client
    return get_mgmt_service_client(cli_ctx, HanaManagementClient)

def _hana_instance_client_factory_v2017_11_03_preview(cli_ctx, *_):
    from azext_hanaonazure.modules_sdk.v2017_11_03_preview import HanaManagementClient
    from azure.cli.core.commands.client_factory import get_mgmt_service_client
    return get_mgmt_service_client(cli_ctx, HanaManagementClient)

def cf_hanainstance_groups(cli_ctx, *_):
    return _hana_instance_client_factory_v2017_11_03_preview(cli_ctx).hana_instances
